...
class MenorPreco extends react_1.Component {
    constructor() {
        super(...arguments);
        this.state = {
            hospedagens: [],
    ...
    componentDidMount() {
        return __awaiter(this, void 0, void 0, function* () {
            const apiMenorPreco = axios_1.default.create({
                baseURL: "http://localhost:4000/casas/ordenarPorMenorPreco",
            });
            const response = yield apiMenorPreco.get("");
...
exports.default = MenorPreco;
//# sourceMappingURL=MenorPreco.js.map